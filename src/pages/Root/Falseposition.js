...
class Falseposition extends React.Component {
  ...
  componentDidMount = async () => {
    await api.getMovieById("5e730ea314095d0970c8af93").then(db => {
      this.setState({
    ...
    return (
      <div>
        <form action="">
          ...
          <ButtonGroup>
            <Button className="mt-4" color="success" type="submit" onClick={this.FP}>Submit</Button>
            <Button className="mt-4" color="warning" type="submit" onClick={this.FP_API}>API</Button>
          </ButtonGroup>
